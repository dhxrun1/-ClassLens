# Lens — API First Attendance System

**Lens** is a facial recognition-based student attendance system designed for educational institutions. It bridges the gap between raw biometric data and actionable insights, providing a seamless interface for verifying presence and managing student records.
...
Processes a class photo, identifies students, and records attendance.
